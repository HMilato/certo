...
//    }
    public void onEditPresc(final ForwardEvent evt) throws Exception {
        Messagebox.show("Regularizar a prescri��o?", "Confirma��o", Messagebox.YES | Messagebox.NO, Messagebox.QUESTION,
                new EventListener() {
                    @Override
...
//        Constraint k = null;
//        winAddPresc.setParent(winEstPrec);
//        winAddPresc.setTitle("Nova Prescri��o");
//        winAddPresc.doModal();
...
//        }
    ...
    public void onSalvar() {
        if (cbinscricao.getSelectedCount() == 0) {
            Clients.showNotification(" Por favor seleccione uma inscri��o!", "error", null, null, 0);
            return;
        }
        ...
        if (dabdatai.getValue().after(id.getInscricao().getDataInscricao())) {
            Clients.showNotification(" A data da Inscri��o antecedente deve ser inferior que a data da �ltima inscri��o!", "error", null, null, 0);
            return;
        }
...
//                                Prescricao p = d.getPrescricao();
    ...
    public void onExcelExport() throws ParseException {
        ...
        beanToExcel.setDataSheetName("Estudantes com Prescri��o");
