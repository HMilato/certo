...
//        par.clear();
    ...
    public void onExcelExportLista() throws ParseException {
        ...
        beanToExcel.setDataSheetName("Distribuicao de Servi�o Docente - " + ((Curso) cbCursoPrec.getSelectedItem().getValue()).getDescricao() + " " + cbSemPrec.getSelectedItem().getLabel());
