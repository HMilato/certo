...
public class RecuperacaoController extends GenericForwardComposer {
    ...
    String msg = "N�o existe nenhum usuario com este email no Sistema", type="error", posicao="middle_center";
    String       msgErroConexao = "N�o foi poss�vel enviar o email, por favor verifique a sua Internet";
    String msgSucesso = "Enviamos para o seu email as instru��es"
...
//                    tokens_nao_usados = ct.getTime();
                  ...
                  //  tk.setValidadeToken(token_expirar);
                    ...
                    if (transport != null && transport.isConnected()) {
                        ...
                        try {
                           ...
                           String htmlText = "<h1>Sauda��es "+us.getNome()+" </h1> \n" +
                           "<h2>Recebemos um pedido de recupera��o de senha, se n�o foi voc�, "
                           + "por favor ignore este e-mail,</h1>\n" +
                            "<h2>mas se foi voc� por favor pressione no bot�o abaixo. Aten��o: Tem no maximo 15 minutos para terminar esse processo</h2>\n" 
              ...
              //Clients.showNotification("Enviamos as instrucoes de recupera��o de senha para o seu email"); 
        }
    }
