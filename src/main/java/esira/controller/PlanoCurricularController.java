...
//        }
    ...
    public void onDeleteDiscip(final ForwardEvent evt) throws Exception {
        Messagebox.show("Apagar?", "Conirma��o", Messagebox.YES | Messagebox.NO, Messagebox.QUESTION,
                new EventListener() {
                    @Override
...
//        Messagebox.show("Pretende eliminar a precedencia?", "Confirma��o", Messagebox.YES | Messagebox.NO, Messagebox.QUESTION,
//                new EventListener() {
//                    @Override
//                    public void onEvent(Event evet) {
//                        switch (((Integer) evet.getData()).intValue()) {
...
//        Messagebox.show("Pretende modificar?", "Confirma��o", Messagebox.YES | Messagebox.NO, Messagebox.QUESTION,
//                new EventListener() {
//                    @Override
//                    public void onEvent(Event evet) {
//                        switch (((Integer) evet.getData()).intValue()) {
