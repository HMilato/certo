...
//        c.addForward("onSelect", "self", "onSelectT");
        c.setValue("---Selecione o tipo de Avalia��o---");
    ...
    public void onClick$adtipo() {
        ...
        c.setConstraint(" no Empty: Seleccione um tipo de avali��o!");
    ...
    public void onRefazer() {
        Messagebox.show("Pretende refazer o plano de avalia��o?", "Prompt", Messagebox.YES | Messagebox.NO, Messagebox.QUESTION,
                new EventListener() {
            @Override
