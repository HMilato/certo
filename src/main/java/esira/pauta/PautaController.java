...
//        int edicao = ibedicao.getValue();
        ...
        try {
            ...
            if (pauta == null) {
                ...
                pauta.setDescricao("Pauta de Frequ�ncia");
        ...
        while (rs.next()) {
            ...
            if (ordem == -2 && pa.getClassfreq() != null && !pa.getClassfreq().isEmpty()
                ...
                if (p != null && p.getEstado() != null && p.getEstado() > 0) {
                    ...
                    && pa.getClassexame().equalsIgnoreCase("Recorr�ncia")&&(notaextra==null||notaextra<10)) {
    ...
    public void onNotaExam(InputEvent event) {
        ...
        if (event.getValue() != null && !event.getValue().isEmpty() && cb.getSelectedIndex() < 1) {
            ...
            if (nexame >= 10) {
                ...
                if (ordem == -2) {
                    ((Label) li.getLastChild().getPreviousSibling().getFirstChild()).setValue("Recorr�ncia");
