            ...
            if (rwnrm.isVisible()) {
                if (nrmec.isVisible()) {
                    if (nrmec.getValue().length() < 11) {
                        ...
                        Clients.showNotification("Para o Nr. Mec., introduza no m�nimo 11 digitos", "error", null, null, 0);
                        return;
                    }
...
//                Messagebox.show("Registar a Equival�ncia das Disciplinas", "", Messagebox.YES | Messagebox.NO, Messagebox.QUESTION,
//                        new EventListener() {
//                            @Override
...
//                                        .getItemAtIndex(litem.getValue()));
    ...
    public void onCheNrm() {
        ...
        if (nrmec.isVisible()) {
            ...
            nrmec.setConstraint(" no Empty: Introduza o nr Mecanogr�fico!");
        }
    }
