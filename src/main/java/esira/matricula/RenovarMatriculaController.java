...
//    private ListModel<Sexo> sexoModel;
    ...
    public void onClick$btnAvancar3() {
        if (camposNulosHA()) {
            validation.setValue("Preencha todos campos * do Historial Acad�mico");
        } else {
            validation.setValue("");
    ...
    public void onClick$btnAvancar4() {
        if (camposNulosDE()) {
            validation.setValue("Preencha todos campos * dos Dados Econ�micos");
        } else {
            validation.setValue("");
    ...
    public void onClick$btnAvancar5() {
        if (camposNulosDoc()) {
            validation.setValue("Preencha todos campos * da Documenta?�o");
        } else {
            validation.setValue("");
            calcularTotal();
