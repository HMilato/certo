...
//                        }
                        try {
                            try {
                                new Email().sendEmailReciboMat(getServletContext(), csimp, UserAutentic.getEmailP2("email", getServletContext()),
                                        estudante.getEmail(), "Valida��o de Matricula", "Caro Estudante " + estudante.getNomeCompleto() + ""
                                        + "\nA sua matricula foi validada com Sucesso\n"
                                        + s + "\n\n------------------------------------------\n\n\n"
                                        + "Registo Acad�mico - UniL�rio-" + fa.getDesricao(),
                        ...
                        try {
                            new Email().sendEmailReciboInsc(getServletContext(), csimp, UserAutentic.getEmailP2("email", getServletContext()),
                                    i.getIdEstudante().getEmail(), "Valida��o de Inscri��o", "Caro Estudante " + estudante.getNomeCompleto() + ""
                                    + "\nA sua Inscri��o foi validada com Sucesso\n\n----------------------------------------\n\n\n"
                                    + "Registo Acad�mico - UniL�rio-" + f.getFaculdade().getDesricao(),
                        ...
                        try {
                            new Email().sendEmail(UserAutentic.getEmailP2("email", getServletContext()),
                                    i.getIdEstudante().getEmail(), "Inscri��o Rejeitada!", "Caro Estudante " + estudante.getNomeCompleto() + ""
